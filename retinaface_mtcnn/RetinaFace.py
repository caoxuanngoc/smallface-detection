#sử dụng mô hình RetinaFace để phát hiện và trích xuất khuôn mặt từ ảnh
import warnings
...
from retinaface_mtcnn.model import retinaface_model
from retinaface_mtcnn.commons import preprocess, postprocess
